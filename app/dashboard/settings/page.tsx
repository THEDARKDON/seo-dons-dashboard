            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-lg mt-1">
                  {(user.voip as any)?.assigned_phone_number || 'Not assigned'}
                </p>
              ...
              <div>
                ...
                <p className="text-lg mt-1">
                  {(user.voip as any)?.caller_id_number || (user.voip as any)?.assigned_phone_number || 'Not configured'}
                </p>
                <p className="text-sm text-gray-400 mt-1">
              ...
              <div>
                ...
                <p className="text-lg mt-1">
                  {(user.voip as any)?.auto_record === false ? 'Disabled' : 'Enabled'}
                </p>
                <p className="text-sm text-gray-400 mt-1">
