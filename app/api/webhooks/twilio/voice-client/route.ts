...
<Response>
  <Dial callerId="${callerId}" record="record-from-answer" recordingStatusCallback="${process.env.NEXT_PUBLIC_APP_URL}/api/webhooks/twilio/recording" recordingStatusCallbackEvent="completed">
    <Number>${to}</Number>
  </Dial>
</Response>`;
